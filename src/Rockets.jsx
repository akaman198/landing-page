        ...
        <section id="rockets" className="p-6 my-12 scroll-mt-20 widescreen:section-min-height tallscreen:section-min-height">
            ...
            <ul className="list-none mx-auto my-12 flex flex-col sm:flex-row items-center gap-8">
                <li
                    ...
                    <img src="./src/img/rocketman.png" alt="Explorer" className="w-1/2 mb-6"/>
                ...
                <li
                    className="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-white dark:bg-black py-6 px-2 rounded-3xl shadow-xl">
                    <img src="./src/img/rocketride.png" alt="Adventurer" className="w-1/2 mb-6"/>
                ...
                <li
                    className="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-white dark:bg-black py-6 px-2 rounded-3xl shadow-xl">
                    <img src="./src/img/rocketlaunch.png" alt="Infinity" className="w-1/2 mb-6"/>
